...
<body>
	...
	<h1 style="text-align:center; font-family: sofia, sans-serif;">Booking Form</h1>
 <form action="book.php" class="form1" method="POST">
  <table>
   <tr>
   ...
   <tr>
    ...
    <td><input type="submit" name="book" class="btn" value="book">   </td>   
 ...
 <?php
  ...
  if(isset($_POST['book'])){
    ...
    $query="INSERT INTO `book_now`(`name`, `address`, `gender`, `email`, `ph_code`, `phone_no`,`Requirements`) VALUES ('".$username."','".$address."','".$gender."','".$email."','".$phoneCode."','".$phone."','".$Requirements."')";
    
    
    
       if($result=mysql_query($query)){
      
        echo '<script>alert("Order booked Sucessfully.");</script>';
