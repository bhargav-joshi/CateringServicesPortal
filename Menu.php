...
<div id="product-grid">
	...
	?>
		<div class="product-item">
			...
			<div class="cart-action"><input type="text" class="product-quantity" name="quantity" value="1" size="2" /><input type="submit" value="Add to Cart" class="btnAddAction" /><br><br></div>
